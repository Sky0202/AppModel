...
public class SuperTextView extends AppCompatTextView {
    ...
    private void setup(AttributeSet attrs) {
        ...
        mDuration = a.getInteger(R.styleable.SuperTextView_animationDuration, mDuration);
        ...
        mRound = a.getBoolean(R.styleable.SuperTextView_round, false);
        ...
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.SuperTextView_strokeDashWidth, 0);
