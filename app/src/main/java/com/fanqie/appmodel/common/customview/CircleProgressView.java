...
public class CircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setStrokeWidth(mCircleLineStrokeWidth - 5);
        ...
        // 设置渐变色
        LinearGradient linearGradient = new LinearGradient(mRectF.left, mRectF.top, mRectF.right, mRectF.bottom, Color.BLUE, Color.RED, Shader.TileMode.REPEAT);
        ...
        if (!TextUtils.isEmpty(mTxtHint2)) {
            ...
            textWidth = (int) mPaint.measureText(text, 0, text.length());
            mPaint.setStyle(Paint.Style.FILL);
            canvas.drawText(text, width / 2 - textWidth / 2, 3 * height / 5 + textHeight / 2, mPaint);
        }
    }
